CREATE TABLE `risk_skills` (
	...
	CONSTRAINT "risk_skills_review_status_check" CHECK("risk_skills"."review_status" IN ('draft', 'reviewed')),
...
CREATE INDEX `risk_skills_updated_idx` ON `risk_skills` (`updated_at`);--> statement-breakpoint
