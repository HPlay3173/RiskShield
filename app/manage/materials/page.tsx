  ...
  return (
    <AdminShell currentHref="/manage/materials" principal={presentation} title="자료 추가" description="새 위험 표현을 찾을 자료를 등록하고, 등록이 끝나면 후보 생성으로 이어갑니다.">
      <section className="managementTaskGrid" aria-label="자료 추가 방법">
        ...
        <Link className="managementTaskCard" href="/manage/materials/public"><span>02 · 공개 글</span><strong>글 묶음 직접 등록</strong><p>확보한 공개 글이나 댓글을 한 줄씩 등록합니다. 자동 수집 설정은 Labs에서만 제공합니다.</p><b>공개 글 등록 →</b></Link>
      </section>
