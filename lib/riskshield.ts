...
export const starterSkills: RiskSkill[] = [
  ...
  seedSkill({
    id: "risk_history_000002",
    category: "역사·기념일 민감성",
    subcategory: "설명 없이 삽입된 5·18 은닉 신호",
    patternType: "coded_historical_date + unexplained_placement",
    ...
    contextPatterns: [],
    exclusionPatterns: [
      "회의", "일정", "예약", "마감", "생일", "배송", "주문", "상품 번호", "제품 번호",
      "모델 번호", "페이지", "주소", "전화번호", "호실", "날짜",
      "5·18 민주화운동", "5.18 민주화운동", "5/18 민주화운동", "5월 18일",
      "역사", "수업", "교육", "기사", "보도", "논란", "비판", "사과", "추모",
    ],
    surfaceMeaning: "설명되지 않은 518 계열 숫자나 탱크데이 표현이 홍보 문맥에 삽입됩니다.",
    riskSummary: "평범한 날짜·숫자로 위장한 역사적 은닉 신호 또는 최신 논란 표현일 수 있어 문맥 검토가 필요합니다.",
    socialContext: "518은 5·18 민주화운동을 가리키는 숫자 표현으로 사용될 수 있으며, 무관한 홍보 문구에 뜬금없이 배치되면 의도와 수용 맥락을 확인해야 합니다.",
    legalOrEthicIssue: "역사적 희생을 암시적으로 상업화하거나 조롱하는 표현으로 받아들여질 수 있습니다.",
    riskReason: "518 계열 숫자 또는 탱크데이 표현이 명확한 일정·교육·보도 설명 없이 등장합니다.",
    severityFloor: 58,
    dominantRisk: false,
    confidence: 0.72,
    riskDomain: "역사·기념일 광고",
    recentContextTags: ["5·18", "은닉 숫자", "탱크데이", "문맥 이탈"],
    safeRewrite: ["행사 취지와 직접 관련된 이름과 날짜 표현으로 바꿔 주세요."],
    falsePositiveNote: "일정·주문번호·교육·보도·추모처럼 518의 사용 이유가 명확하면 제외합니다.",
    source: {
      title: "스타벅스, 5·18에 '탱크데이' 할인 행사…부적절한 문구 사과",
      url: "https://imnews.imbc.com/news/2026/society/article/6823375_36918.html",
      date: "2026-05-18",
      sourceId: "mbc_20260518_tank_day",
      provenanceStatus: "verified",
    },
  }),
  seedSkill({
    id: "risk_history_000003",
    category: "역사·기념일 민감성",
    subcategory: "5·18과 탱크 표현을 결합한 판촉",
    patternType: "coded_historical_date + tank_campaign",
    riskFamily: "general_substantiation",
    triggerPatterns: [
      "re:(?<!\\d)(?:5\\s*[·./-]\\s*18|518)(?!\\d)",
    ],
    contextPatterns: [
      "탱크데이", "탱크 데이", "탱크", "책상에 탁", "할인", "특가", "세일",
      "프로모션", "이벤트", "행사", "쿠폰", "한정 혜택",
    ],
    anyOfPatterns: ["re:(?:탱크|할인|특가|세일|프로모션|이벤트|행사|쿠폰|혜택)"],
    exclusionPatterns: ["기사", "보도", "논란", "비판", "사과", "중단", "교육", "수업", "역사 설명"],
    conditionScope: "paragraph",
    maxDistance: 120,
    surfaceMeaning: "5·18을 나타낼 수 있는 숫자를 탱크 표현이나 판촉 혜택과 결합합니다.",
    riskSummary: "5·18 민주화운동의 희생과 계엄군 투입을 연상시키는 상업적 표현으로 강한 반발을 일으킬 수 있습니다.",
    socialContext: "5·18 당일 탱크데이 판촉이 역사적 참상을 상업적으로 소비했다는 비판을 받아 중단된 사례가 있습니다.",
    legalOrEthicIssue: "역사적 희생과 민주주의 가치를 모욕하거나 상업적으로 이용한다는 윤리적 위험이 큽니다.",
    riskReason: "518 계열 날짜와 탱크 또는 판매 혜택 표현이 가까운 문맥에서 결합됩니다.",
    severityFloor: 90,
    dominantRisk: true,
    confidence: 0.97,
    riskDomain: "역사·기념일 광고",
    recentContextTags: ["5·18", "탱크데이", "역사 상업화", "브랜드 위기"],
    safeRewrite: ["역사적 기념일과 무관한 제품명·혜택명으로 행사 문구를 전면 수정해 주세요."],
    falsePositiveNote: "사건을 비판적으로 설명하는 기사·교육·사과 문맥은 제외합니다.",
    source: {
      title: "스타벅스, 5·18에 '탱크데이' 할인 행사…부적절한 문구 사과",
      url: "https://imnews.imbc.com/news/2026/society/article/6823375_36918.html",
      date: "2026-05-18",
